            ...
            <Box sx={{ mt: 'auto', pt: 3, display: 'flex', flexDirection: 'column', gap: 2 }}>
              <Button
                ...
                sx={{
                  ...
                  py: 2,
                  background: '#5ec837',
                  boxShadow: '0 8px 20px rgba(94, 200, 55, 0.2)',
                  color: '#FFFFFF',
                  border: '1px solid rgba(94, 200, 55, 0.1)',
                  '&:hover': {
                    background: '#4eb02c',
                    boxShadow: '0 10px 25px rgba(94, 200, 55, 0.3)',
                  },
                  textTransform: 'none',
                  fontWeight: 700,
                  fontSize: '1.1rem',
              ...
              <Button
                ...
                sx={{
                  ...
                  borderColor: '#5ec837',
                  color: '#5ec837',
                  backgroundColor: 'rgba(94, 200, 55, 0.1)',
                  backdropFilter: 'blur(5px)',
                  '&:hover': {
                    borderColor: '#4eb02c',
                    backgroundColor: 'rgba(94, 200, 55, 0.2)',
