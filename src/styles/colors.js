...
export const COLORS = {
  // Ana Renkler
  PRIMARY_BG: '#1b293d',        // Ana arkaplan rengi
  SIDEBAR_BG: '#1b293d',        // Sidebar arkaplan rengi
  CARD_BG: '#2d4870',           // Kart arkaplan rengi
  HEADER_BG: '#1b293d',         // Header arkaplan rengi
  ...
  BORDER: '#1b293d',            // Kenarlık rengi
  
  // Gradient Renkler (Login sayfası için)
  GRADIENT_START: '#1b293d',
  GRADIENT_MID: '#2d4870',
  GRADIENT_END: '#2d4870',
  ...
  dark: {
    background: '#1b293d',
    backgroundRgb: [27, 41, 61],
    cardBackground: '#2d4870',
    appBarBackground: '#1b293d',
    drawerBackground: '#1b293d',
    text: '#ffffff',
